<?php namespace VaahCms\Themes\Blog\Models;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Crypt;
use Illuminate\Support\Str;
use VaahCms\Themes\Blog\Notifications\ActivationLinkNotification;
use WebReinvent\VaahCms\Entities\Registration;
use WebReinvent\VaahCms\Entities\User;

class BlogRegistration extends Registration
{
	...
	public static function activateRegistration($request)
    {
        ...
        // Create User
        $user = BlogUser::createUser($user_request);
        ...
        $response['status'] = 'success';
        $response['data']['redirect_url'] = route('vh.frontend.blog.signin');
